...
public class Main {
    ...
    private static final AnalysisResult analysisResult = new AnalysisResult();
    ...
    private static String toFlatString(Stack<String> stack) {
    ...
    private static void generateAnalyzingTable() {
    ...
    private static void initAnalyzingTable() {
    ...
    private static void generateFollowSetMap() {
        boolean dirty = true;
        while (dirty) {
            dirty = false;
    ...
    private static Set<String> getFirstSet(String symbolStr){
    ...
    private static void generateFirstSetMap() {
        boolean dirty = true;
        while (dirty) {
            dirty = false;
            for (Map.Entry<String, Set<String>> formula : formulaSetMap.entrySet()) {
    ...
    private static boolean isAllContainsE(String string) {
    ...
    private static boolean isAllNoneTerminal(String string) {
    ...
    private static boolean try2add(String value, Set<String> targetSet) {
